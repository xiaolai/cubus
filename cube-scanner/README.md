...
trained **v3** sticker detector; the classical OpenCV scanner and the live tracker were
...
(`cubedet.onnx`), and onnxruntime-web's `dist/*.wasm` are all served from `app/renderer/vendor/`;
