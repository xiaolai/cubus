...
def main() -> int:
    ...
    report["coreml"] = coreml_matrix(args.models / "cubedet.mlpackage", inputs)
    report["compute_plan"] = compute_plan(args.models / "cubedet.mlpackage")
    ...
    tfl = args.models / "cubedet.tflite"
    report["tflite_proxy_this_mac"] = tflite_proxy(tfl, inputs) if tfl.is_file() else {"skipped": "no cubedet.tflite"}
