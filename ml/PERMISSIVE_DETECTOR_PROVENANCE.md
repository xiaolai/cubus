...
Until 2026-09-17, `apps/web/vendor/cubedet.onnx` was a v3n fine-tuned with
...
2. the **starting weights** — `base11n.pt`, which `ml/train.sh` seeds and fine-tunes from. Those
