...
ml/venv/bin/python ml/ood_eval.py    --model ml/models/cubedet.onnx --images /tmp/ood --out /tmp/ood_out
...
ml/venv/bin/python ml/ood_report.py  --out /tmp/ood_out --dest dev-docs/artifacts/cubedet-ood-report.html \
