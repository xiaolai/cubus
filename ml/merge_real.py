"""Merge the downloaded Roboflow cube datasets into one detector set with OUR class scheme.
...
def read_names(yaml_path: str) -> list[str]:
    """Parse the ordered class-name list from a detector data.yaml (dash-list or inline [..])."""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", required=True, help="output merged detector dataset dir")
    args = ap.parse_args()
