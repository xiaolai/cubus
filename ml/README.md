...
v3n pipeline that produced v3, the model it replaced, was removed on 2026-09-18 (§"v3").
...
mAP rows among them came from Detlib's validator (`detector val`), which `metrics_table.py` no longer
