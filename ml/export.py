...
| cube-yolo.mlpackage   | Apple (CoreML, macOS + iOS)      | ML program; fp32 for cubedet (measured faster AND exact), fp16 for the Detlib path |
| cube-yolo.tflite      | Android APK, gated OFF (LiteRT)  | fp32 for cubedet; dynamic-range int8 for the Detlib path |
