...
# then converts the accumulated COCO to detector labels and splits train/val. Total images ≈
...
echo "Converting COCO -> detector labels…"
python3 "$HERE/coco_to_labels.py" "$OUT/coco/coco_annotations.json" "$OUT/labels_all"
