...
# BlenderProc synthetic cube-FACE generator with domain randomization + auto detector labels.
...
# per-sticker occlusion-aware boxes with zero manual labelling. Output COCO → coco_to_labels.py.
...
# detector classes: 0 white 1 red 2 green 3 yellow 4 orange 5 blue (see data.yaml). In the COCO
# file these are stored 1-indexed (white=1..blue=6, body=7) because BlenderProc reserves
# category_id 0 for background; coco_to_labels.py shifts them back to 0..5.
