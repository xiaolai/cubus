...
<p>Scored with the same tool (<code>detector val</code>) that produced 0.973 — first <b>reproduced</b>
...
<title>cubedet — honest OOD evaluation</title>
<style>
...
<h1>cubedet: how good is it, <em>really</em>?</h1>
...
<ul>
  <li>These are <b>label-free</b> signals (detection rate, confidence, the geometry gate) — not mAP.
    A true OOD mAP needs hand-labelled ground truth; ood_eval.py already emits detector pre-labels to correct.</li>
