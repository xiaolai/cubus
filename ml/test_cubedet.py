...
def _tiny_dataset(tmp_path, n=8):
    """A few 640×640 frames with one bright square each, in detector layout."""
...
def test_export_graph_reads_no_tensor_shapes():
    ...
    no cubedet model could produce a TFLite file at all while the detector model it replaces converted
