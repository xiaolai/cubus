...
- **Input:** 640×640 letterboxed RGB (Detlib-style, grey-114 pad).
...
The detector is a YOLO model trained with [Detlib](https://github.com/detlib/detlib)
...
`cube-yolo.onnx`. It needs an Detlib Enterprise Licence, or a detector trained on a stack that
