...
|---|---|
| mAP50 / mAP50-95 / P / R (`detector val`) | 0.878 / 0.772 / 0.862 / 0.860 |
...
reads on all 20 golden fixtures and identical `detector val` rows to the file it replaced), the manifest
