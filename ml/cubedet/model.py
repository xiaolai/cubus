...
#
# WHY THIS FILE EXISTS AT ALL: the shipped detector was fine-tuned with Ultralytics, which is
# AGPL-3.0, and Ultralytics' stated position is that the licence reaches models trained with their
