...
- [ ] a change under `packages/cube-scanner`, `packages/cubus-cube`, or a bundle entry rebuilt and committed the vendored bundle (`pnpm build:panel`, `build:cube`, `build:cubejs`, `build:smartcube`, `build:mcp-guest`)
