...
- **Scan with a camera.** A detector sticker detector reads a face at a time; a misread is refused
...
Detlib, which is MIT, and a permissive licence here would not be honest about that.
