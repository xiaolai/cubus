  ...
  html: `<div class="cols">
    ...
    <div class="aside">
      ...
      <div class="card"><b style="font-size:var(--fs-body-l)">How it works</b>
        <div class="sub" style="color:var(--ink-4);margin-top:4px">The detector scanner reads stickers on device. A validated six-face read jumps straight to the solve guide.</div></div>
