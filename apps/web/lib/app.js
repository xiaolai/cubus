...
// gan-driver transport seam (Web Bluetooth / Tauri native BLE), and the detector camera scanner.
  ...
  return {
    ...
    <div class="aside">
      ...
      <div class="card"><b style="font-size:var(--fs-body-l)">How it works</b>
        <div class="sub" style="color:var(--ink-4);margin-top:4px">The camera opens with this screen and the detector scanner reads the stickers on device — no picture is kept, and none leaves it. Show the sides in any order; each is captured as soon as it holds still.</div></div>
