...
export const SOURCES = Object.freeze([
  ...
  { stage: 'F2L', where: 'not taught; app joined-pairs rung and the 41 cases in lib/data/case-tables.js', uses: ['face-turns', 'highlight-piece', 'stop-playback'], wants: ['several-cubes'], ready: ['flat-view', 'hold-change-in-sequence', 'question'] },
  { stage: 'OLL and PLL', where: 'app Trainer and Drill previews; the 57 and 21 cases', uses: ['page-overlay'], wants: ['several-cubes'], ready: ['flat-view', 'trail', 'wide-move', 'rotation-token', 'highlight-sticker', 'drill-round'] },
