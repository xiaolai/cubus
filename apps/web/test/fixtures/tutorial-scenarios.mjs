...
export const SOURCES = Object.freeze([
  ...
  { stage: 'OLL and PLL', where: 'app Trainer and Drill previews; the 57 and 21 cases', uses: ['page-overlay'], wants: ['flat-view', 'several-cubes'], ready: ['trail', 'wide-move', 'rotation-token', 'highlight-sticker', 'drill-round'] },
